...
class XEyTransformerLayer(nn.Module):
    ...
    def forward(self, X: Tensor, E: Tensor, y):
        ...
        newX, newE, new_y = self.self_attn(X, E, y)
...
class NodeEdgeBlock(nn.Module):
    ...
    def forward(self, X, E, y):
        ...
        attn = torch.softmax(Y,  dim=2)  # bs, n, n, n_head
...
class GraphTransformer(nn.Module):
    ...
    def forward(self, X, E, y):
        ...
        return diffusion_utils.PlaceHolder(X=X, E=E, y=y)  
